...
photo=PhotoImage(file="image_f/school_logo.png") #PhotoImage를 통한 이미지 지정
...
canvas.create_line(20, 3, 20, 1000,fill="black", width = 3)
...
canvas.create_line(20, 1000, 1272, 1000,fill="black", width = 3)
canvas.create_line(1272, 3, 1272, 1000,fill="black", width = 3)

canvas.create_line(22, 636, 1272, 636,fill="gray", width = 1.5)

canvas.create_line(22, 437, 1272, 437,fill="gray", width = 1.5)
...
class PrintRQ:
    ...
    def rqprint(self):
         Ready_Queue = Label(root, text="                                                                                             ", background = "white", font = ("",10))
         Ready_Queue.place(x=50,y=410)
         if self.count < self.n:
             
             Ready_Queue = Label(root, text=self.readyqueue[self.count], background = "white", font = ("",10))
             Ready_Queue.place(x=50,y=410)
             c_label = Label(root, text= self.count , background = "white", font = ("",10))
             c_label.place(x=160,y=384)
             self.count+=1

             s_label = Label(root, text= "seconds", background = "white", font = ("",10))
             s_label.place(x=180,y=384)
...
class PrintGanttchart:
    def __init__(self, core, p, coreinfo):
        self.core = core
        self.coreinfo = coreinfo
        self.count = 0
        self.p = p
        self.t = len(core[0])
        self.color =["pink", "lavender", "palegreen",
                    "lightskyblue", "darkseagreen", "peru", 
                    "aquamarine", "gold", "cadetblue", 
                    "dodgerblue","salmon","orange",
                     "slateblue", "silver", "mediumorchid", 
                    "deeppink", "pink", "peru"]
    def ganttchartprint(self):
         Ready_Queue = [0]*self.p
         if self.count < self.t:
             for i in range(self.p):
                v = self.core[i][self.count]
                if v == 0:
                    Ready_Queue[i] = Label(root, text='  ', background = "white", font = ("",10),width= 2, height = 2)
                else:
                    Ready_Queue[i] = Label(root, text='P'+str(v), background = self.color[v-1], font = ("",10),width= 2, height = 2)
                Ready_Queue[i].place(x=95+22*self.count,y=472+35*i)
                Time = Label(root, text=self.count, background = "white", font = ("",10))
                Time.place(x=90+22*self.count,y=470+35*self.p)
             self.count+=1
             root.after(1000,self.ganttchartprint)
         else: # after함수 Stop
             Time = Label(root, text=self.count, background = "white", font = ("",10))
             Time.place(x=90+22*self.count,y=470+35*self.p)
             pass
    ...
    def printrine(self):
        ...
        for i in range(self.p):
                s =self.coreinfo[i]
                Core_name[i] = Label(root, text=s, background = "white", font = ("",10))
                Core_name[i].place(x=50 ,y=478+37*i)
...
Arrival_Time.place(x=50,y=110)
Burst_Time = Label(root, text="실행시간 (BT)",background = "white")
Burst_Time.place(x=50,y=130)
...
Ecore = Label(root, text="E코어 수        프로세서 수 - P코어 수",background = "white")
Ecore.place(x=50,y=213)

excution_speed = Label(root, text="실행 속도       1000ms",background = "white")
excution_speed.place(x=50,y=233)

Ready_Queue = Label(root, text="[ Ready Queue ]",background = "white")
Ready_Queue.place(x=50,y=380)

Gantt_Chart = Label(root, text="[ Gantt Chart ]",background = "white")
Gantt_Chart.place(x=50,y=442)
...
def add_click():
    ...
    name = 'P'+ str(Pname_count) #Entry.get(process_name_)  # 문자
...
Arrival_Time_.place(x=150,y=110)
Burst_Time_ = Entry(root, width=20, borderwidth = 2)
Burst_Time_.place(x=150,y=130)
...
def setting():
    ...
    if scheduling_method == "RR":
        ...
        core = RR.getLOG()
        coreinfo = RR.getCORETYPES()
        p = PrintGanttchart(core,P,coreinfo)
        p.printrine()
        p.ganttchartprint()
        ...
        # getTOTALPOWER()
        t_power = Label(root, text= RR.getTOTALPOWER(), background = "white", font = ("",13))
        t_power.place(x=1150,y=760)
    ...
    if scheduling_method == "SPN":
        ...
        # getTOTALPOWER()
        t_power = Label(root, text= SPN.getTOTALPOWER(), background = "white", font = ("",13))
        t_power.place(x=1150,y=760)
    ...
    if scheduling_method == "SRTN":
        ...
        # getTOTALPOWER()
        t_power = Label(root, text= SRTN.getTOTALPOWER(), background = "white", font = ("",13))
        t_power.place(x=1150,y=760)
    ...
    if scheduling_method == "FCFS":
        ...
        #getTOTALPOWER()
        t_power = Label(root, text= fcfs.gettotalpower(), background = "white", font = ("",13))
        t_power.place(x=1150,y=760)
    ...
    if scheduling_method == "HRRN":
        ...
        # getTOTALPOWER()
        t_power = Label(root, text= hrrn.gettotalpower(), background = "white", font = ("",13))
        t_power.place(x=1150,y=760)
    ...
    if scheduling_method == "SBTQ":
        ...
        # getTOTALPOWER()
        t_power = Label(root, text= sbtq.gettotalpower(), background = "white", font = ("",13))
        t_power.place(x=1150,y=760)
...
lbl = tkinter.Label(root, text="[ Scheduling Results Table  ]",background = "white")
lbl.place(x=328,y=638)
...
Power_Consumption_table.place(x=850,y=668)
...
class FCFS:
    ...
    def __init__(self, N, P, Pcore, AT, BT):
        ...
        self.coreinfostr=[]#코어 종류 문자로 저장
        self.core = [[],[],[],[]]#코어 동작 저장
        self.readyqueueinfo = [] #레디큐 저장
        self.readyqueue = []  #레디큐
        self.readyqueuetmp= [] #레디큐 문자로 저장
        self.start = [0]*N #시작시간
        self.end = [0]*N #종료시간
        self.WT = [] #WT
        self.TT = [] #TT
    ...
    def runningFCFS(self):
        ...
        while count>0:
            ...
            for i in range(self.P):#프로세서 개수 만큼 반복
                if turn[i] == 0: #빈프로세서가 있다면
                    if self.readyqueue: #레디큐에 프로세스가 있다면
                        ...
                        self.start[turn[i]-1] = time #프로세시 실행 시작 시간 저장
            ...
            #프로세서 동작
            for i in range(self.P):
                self.core[i].append(turn[i])#프로세서에 현재 실행 중인 프로세스 정보 저장(0인 경우 대기 중)
    ...
    def setpower(self):
        for i in range(self.P):
            ...
            self.totalpower += tmp
        self.totalpower = round(self.totalpower, 2)
    ...
    def getcore(self): #코어별 프로세스 처리 과정 데이터 반환
        return self.core
    def getcoreinfostr(self): #코어 종류 반환(1:P코어, 2:E코어)
        return self.coreinfostr
                ...
                if turn[i] == 0:#빈프로세서가 있다면
                    if self.readyqueue:#레디큐에 프로세스가 있다면
                        ...
                        if self.start[turn[i]-1]==0 :
                            self.start[turn[i]-1] = time #프로세스 첫 시작 시간 저장
                        workstart[turn[i]-1] = time #자원 할당 받을때마다 저장
            ...
            for i in range(self.P):
                if turn[i] != 0:
                    ...
                    if self.BT[turn[i]-1]<=0:#모두 실행한 경우
                        ...
                        if time - workstart[turn[i]-1]+1 >= TQ:
